...
public class ProvinceParserHandler extends DefaultHandler {

    /**
     * 存储所有的解析对象
     */
    private List<ProvinceModel> citiesModelList;

    public ProvinceParserHandler() {
    ...
    private ProvinceModel citiesModel;
