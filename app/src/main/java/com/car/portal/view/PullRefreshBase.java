...
import com.car.portal.listener.OnLoadListener;
import com.car.portal.listener.OnRefreshListener;
...
public abstract class PullRefreshBase<T extends View> extends LinearLayout implements
    ...
    protected void initHeaderView() {
        mHeaderView = (ViewGroup) mInflater.inflate(R.layout.listview_header, null);
    ...
    protected void initFooterView() {
        ...
        mFooterView = (ViewGroup) mInflater.inflate(R.layout.listview_footer, null);
    ...
    private void showStatus(int status) {
        ...
        LogUtils.d(VIEW_LOG_TAG, "### status = " + statusString);
    }
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        LogUtils.d(VIEW_LOG_TAG, "@@@ onTouchEvent : action = " + event.getAction());
        switch (event.getAction()) {
            case MotionEvent.ACTION_DOWN:
                mYDown = (int) event.getRawY();
                LogUtils.d(VIEW_LOG_TAG, "#### ACTION_DOWN");
                break;

            case MotionEvent.ACTION_MOVE:
                LogUtils.d(VIEW_LOG_TAG, "#### ACTION_MOVE");
                int currentY = (int) event.getRawY();
                mYDistance = currentY - mYDown;

                LogUtils.d(VIEW_LOG_TAG, "### touch slop = " + mTouchSlop + ", distance = " + mYDistance);
                showStatus(mCurrentStatus);
                ...
                if (Math.abs(mYDistance) >= mTouchSlop) {
                    if (mCurrentStatus != STATUS_REFRESHING) {
                        ...
                        if (mHeaderView.getPaddingTop() > mHeaderViewHeight * 0.7f) {
                            ...
                            mTipsTextView.setText(R.string.pull_down_refresh);
                        }
                    }
    ...
    protected void rotateHeaderArrow() {
        ...
        LogUtils.d(VIEW_LOG_TAG, "------ rotateHeaderArrow");
    ...
    class HeaderViewHideTask extends AsyncTask<Integer, Integer, Void> {
        ...
        protected Void doInBackground(Integer... params) {
            ...
            int step = 1;
            LogUtils.d(VIEW_LOG_TAG, "%%% new : curPaddingTop =" + curPaddingTop + ", targetPadding = "
                    + targetPadding);
            ...
            try {
                do {
                    ...
                    LogUtils.d(VIEW_LOG_TAG, "%%% curPaddingTop = " + curPaddingTop + ", mode = " + mode
                            + ", target = "
                            + targetPadding);
                    Thread.sleep(1);
                } while (true);
    ...
    class FooterViewTask extends AsyncTask<Integer, Integer, Void> {
        ...
        protected Void doInBackground(Integer... params) {
            ...
            int targetPadding = params[0];
            int step = 1;
            LogUtils.d(VIEW_LOG_TAG, "%%% new : curPaddingTop =" + curPaddingBottom
                    + ", targetPadding = "
                    + targetPadding);
            try {
                do {
                    ...
                    LogUtils.d(VIEW_LOG_TAG, "%%% curPaddingTop = " + curPaddingBottom
                            + ", target = "
                            + targetPadding);
                    Thread.sleep(1);
                } while (true);
