...
//    public  WXShare shareimg(Context context, Bitmap bitmap){
//
...
//用 WXWebpageObject 对象初始化一个 WXMediaMessage 对象
        ...
        msg.title =title;
        Bitmap thumbBmp = BitmapFactory.decodeResource(context.getResources(), R.drawable.wxshareimg);
