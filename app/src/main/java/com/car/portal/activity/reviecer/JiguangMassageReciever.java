...
import com.car.portal.activity.PasswordcheckActivity;
import com.car.portal.application.MyApplication;
import com.car.portal.util.LogUtils;
import com.car.portal.util.SoundPoolHelper;
...
public class JiguangMassageReciever extends BroadcastReceiver {
    private static final String TAG = "jiguangceshi";
...
//                new SoundPoolHelper().play(context,R.raw.ring);
                ...
                //打开自定义的Activity
                Intent i = new Intent(context, PasswordcheckActivity.class);
                i.putExtras(bundle);
